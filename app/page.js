  ...
  return (
    <div className="w-full h-screen relative bg-gradient-to-b from-[#db4439] to-[#75241e] overflow-hidden">
      ...
      <div className="absolute top-[46px] left-[64px] flex space-x-10 text-[#eaecd7] text-2xl font-bold font-['Inknut_Antiqua']">
        ...
        <div className="ml-[380px]">Front Page</div>
      </div>

      {/* Main Heading */}
      <div className="absolute top-[313px] left-[143px] text-[#eaecd7] text-[110px] font-black font-['Inknut_Antiqua'] leading-[134.20px]">
        Random Coffee Shop
      </div>
      ...
      <div className="absolute bottom-[30%] right-[10%]">
        <img className="w-[450px] h-[500px]" src="https://images.immediate.co.uk/production/volatile/sites/30/2020/08/flat-white-3402c4f.jpg" alt="Coffee Shop Image" />
      </div>
